...
# Funciones CRUD para la SeleccionTabla Cultivo
...
# Funciones CRUD para la SeleccionTabla Insumo
...
# Funciones CRUD para la SeleccionTabla Cliente
...
# Funciones CRUD para la SeleccionTabla Venta
...
# Funciones CRUD para la SeleccionTabla Detalle_Venta
...
# Ejemplo del menú interactivo para cada SeleccionTabla
while True:
    print("\nSelecciona la SeleccionTabla para realizar la operación CRUD:")
    print("1. Cultivo")
    print("2. Insumo")
    print("3. Cliente")
    print("4. Venta")
    ...
    SeleccionTabla = int(input("Indique la SeleccionTabla: "))

    if SeleccionTabla == 1:
        # Menú de operaciones para Cultivo
        print("\nOpciones para la SeleccionTabla Cultivo:")
        print("1. Insertar")
        print("2. Consultar")
        print("3. Actualizar")
        print("4. Eliminar")
    ...
    elif SeleccionTabla == 2:
        # Menú de operaciones para Insumo
        print("\nOpciones para la SeleccionTabla Insumo:")
        print("1. Insertar")
        print("2. Consultar")
        print("3. Actualizar")
        print("4. Eliminar")
    ...
    elif SeleccionTabla == 3:
        # Menú de operaciones para Cliente
        print("\nOpciones para la SeleccionTabla Cliente:")
        print("1. Insertar")
        print("2. Consultar")
        print("3. Actualizar")
        print("4. Eliminar")
    ...
    elif SeleccionTabla == 4:
        # Menú de operaciones para Venta
        print("\nOpciones para la SeleccionTabla Venta:")
        print("1. Insertar")
        print("2. Consultar")
        print("3. Actualizar")
        print("4. Eliminar")
    ...
    elif SeleccionTabla == 5:
        # Menú de operaciones para Detalle_Venta
        print("\nOpciones para la SeleccionTabla Detalle_Venta:")
        print("1. Insertar")
        print("2. Consultar")
        print("3. Actualizar")
        print("4. Eliminar")
